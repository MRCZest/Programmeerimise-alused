"""
Mia on harjunud elektrihinda vaatama äpist, kus on kirjas, mitu senti maksab kilovatt-tund. Kuna paljudes kohtades on hind näidatud eurodes megavatt-tunni kohta, siis soovib ta hinna teisendamiseks programmi (1 MWh = 1000 kWh).
...
Oluline on, et elektrihinna teisendamise funktsioon ise ei küsiks kasutajalt midagi ja see funktsioon ise ka ei väljastaks tulemust ekraanile. Need tegevused peab tegema põhiprogrammis väljaspool funktsiooni, funktsiooni töö on vaid arvutada ja tagastada tulemus.
...
def convert_price(s_per_kw: float) -> float:
    price_in_eur = s_per_kw / 100
    return price_in_eur * 1000

if __name__ == '__main__':
    given_price_str = input("Sisesta elektrihind sentides kilovatt-tunnis kohta:")
